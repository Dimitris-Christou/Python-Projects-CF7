...
def main():
    my_log_file = 'cf7_2.log'
    
    # Configure logger
    my_logger = configure_logger(my_log_file, 'search-app2')
    employee_names = ['Alice', 'Bob', 'Jhon', 'Charlie', 'Helen', 'Diana']
    employee_to_find = input("Please enter the name of the employee you are searching: ").title()
